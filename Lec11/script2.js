...
// }
// console.log(products.sort(example));


// const a= products.sort((a, b) => a.price - b.price);
// console.log(a);  


// price low to high 
// const a = products.sort((a, b) => a.price - b.price).map((element) => element.title);  // map works here because it is an array and map can work on array 
// console.log(a); 


// const a = products.filter((element) => element.rating > 4.1);
// console.log(a);
...
//     acc = acc + products[i].price;
// }
// console.log(acc);


// function example(acc, a){
//     // console.log(arguments);
//     return acc + a.price;
// }
// console.log(products.reduce(example, 0)); 


// console.log(products.reduce((acc, element) => acc + element.price, 0));  