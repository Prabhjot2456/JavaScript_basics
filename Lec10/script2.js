...
//     mynewarr.push(products[i].title);
// }
// console.log(mynewarr);


// function example(element, index, arr){
//     console.log(element.title);
// }
// products.map(example);
...
//     };
// }
// const a = products.map(example);
// console.log(a);


// make anonymous function with bigfat arrow function
// const a = products.map((element, index, arr)=>{return {name: element.title};});
// console.log(a);

// const a = products.map((element)=> element.title);
// console.log(a);


// const a =products.map((element)=>({name : element.title, price : element.price}))
// console.log(a);
