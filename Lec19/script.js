...
// a.textContent = "Prabh";
// a.setAttribute("id", "prabhjot");
// console.log(a);
// // document.body.innerHTML = a;  cannot use this directly 
...
// h1.setAttribute("id", "heading");        // attribute name, value 
// img.setAttribute("src", "https://cuiet.codebrigade.in//images/logo_373.png");
...
container.setAttribute("id", "milan");
const title = document.createElement("h1");
const img = document.createElement("img");
img.setAttribute("src", "250px");
...
discount.textContent = products[i].discountPercentage;
rating.textContent = products[i].rating;
description.textContent = products[i].description;
container.append(img, title, price, discount, rating, description);
